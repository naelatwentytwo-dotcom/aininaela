...
<head>
  ...
  <title>Kategori Produk - naelaimut</title>
...
<!-- End Icons Navigation -->
            ...
            <div class="card-body">
              ...
              <form class="row g-3" method="post">
                ...
                <div class="text-center">
                  <button type="submit" class="btn btn-warning"><a href="kategori_produk" style="color:black; text-decoration:none;">Kembali</a></button>
                  <button type="reset" class="btn btn-secondary">Reset</button>
                  <button typr="submit" class="btn btn-success" name="simpan">Simpan</button>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="credits">
      ...
      Designed by <a href="https://www.instagram.com/nlleaay_?igsh=azNlZDVhdWxiNGZr">BootstrapMade</a>
    </div>
  </footer><!-- End Footer -->
